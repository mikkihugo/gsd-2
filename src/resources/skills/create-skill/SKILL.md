---
name: create-skill
description: Expert guidance for creating, writing, building, and refining SF skills. Use when working with SKILL.md files, authoring new skills, improving existing skills, or understanding skill structure and best practices.
---
