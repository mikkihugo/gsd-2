...
export type { SFSkillRule, SkillDiscoveryMode, SkillResolution, SkillResolutionReport } from "./preferences-types.js";
 ...
 */
export function resolveAllSkillReferences(preferences: SFPreferences, cwd: string): SkillResolutionReport {
