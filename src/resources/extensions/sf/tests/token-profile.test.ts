...
// ═══════════════════════════════════════════════════════════════════════════
// SFPreferences Interface
// ═══════════════════════════════════════════════════════════════════════════

test("preferences: SFPreferences includes token_profile field", () => {
  assert.ok(
    preferencesSrc.includes("token_profile?: TokenProfile"),
    "SFPreferences should have token_profile field",
  );
});

test("preferences: SFPreferences includes phases field", () => {
  assert.ok(
    preferencesSrc.includes("phases?: PhaseSkipPreferences"),
    "SFPreferences should have phases field",
  );
});
