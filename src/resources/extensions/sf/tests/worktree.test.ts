...
describe('worktree', async () => {
  ...
  console.log("\n=== getSliceBranchName ===");
  assert.deepStrictEqual(getSliceBranchName("M001", "S01"), "sf/M001/S01", "branch name format correct");
  assert.deepStrictEqual(getSliceBranchName("M001", "S01", null), "sf/M001/S01", "null worktree = plain branch");
  assert.deepStrictEqual(getSliceBranchName("M001", "S01", "my-wt"), "sf/my-wt/M001/S01", "worktree-namespaced branch");
