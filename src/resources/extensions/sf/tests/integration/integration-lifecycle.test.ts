...
//
// Crosses ≥4 module boundaries: sf-db, md-importer, context-store, db-writer.
...
import { openDatabase, closeDatabase, isDbAvailable, _getAdapter } from '../../sf-db.ts';
...
test('integration-lifecycle: full pipeline', async () => {
    // ── Step 1: Set up temp dir with realistic .sf/ structure ──────────
