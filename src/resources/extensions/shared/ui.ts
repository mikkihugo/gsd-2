...
import { truncateToWidth, visibleWidth, wrapTextWithAnsi } from "@sf-run/pi-tui";
...
export interface UI {
	...
	editorTheme: import("@sf-run/pi-tui").EditorTheme;
}
...
export function makeUI(theme: Theme, width: number): UI {
	...
	const editorTheme: import("@sf-run/pi-tui").EditorTheme = {
